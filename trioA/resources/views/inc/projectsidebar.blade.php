<div class="sidebar ">
    ...
    <div class="widget border text-center"  style=" border-radius:15px; padding:20px; box-shadow: 3px 2px;">
        ...
        <div class="profile-thumb">
            <img src="/storage/img/projects/images/{{$project->image}}" alt="" class="border rounded-circle " style="border-image-outset: 100px; width:50%; height: 150px;">
        </div>
        ...
        <div  class="list-group text-left">
            ...
            <div id="description" class="border collapse">
                {{($project->description=='')? 'no data':$project->description}}
            </div>
            ...
            <div id="goals" class="border collapse">
                {!! ($project->goals=='')? 'no data':$project->goals !!}
            </div>
        </div>

        <br>
        <a href="/projects/{{$project->id}}/edit" class="btn btn-outline-success">Edit project</a>
    </div>
    <!-- Dashboard Links -->
    <div class="widget border"  style=" border-radius:15px; margin-top:25px; margin-bottom:25px; padding:20px;  box-shadow: 3px 2px;">
        ...
        <div  class="list-group collapse" id="numbers">
            <a class="list-group-item list-group-item-light list-group-item-action">
                ...
                <span class="badge badge-pill badge-primary pull-right">{{($project->created_at=='')? 'not activated':$project->created_at->format('M d,Y')}}</span>
            </a>
            <a class="list-group-item list-group-item-light list-group-item-action">
            ...
            <a class="list-group-item list-group-item-light list-group-item-action">
                <i class="fa fa-bookmark-o"></i> Sub Projects 
                <span class="badge badge-pill pull-right">3</span>
            </a>
            <a class="list-group-item list-group-item-light list-group-item-action">
