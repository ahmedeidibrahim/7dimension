<div class="sidebar ">
    ...
    <div class="widget border text-center"  style=" border-radius:15px; padding:20px; box-shadow: 3px 2px;">
        ...
        <div class="profile-thumb">
            <img src="/storage/img/programs/images/{{$program->image}}" alt="" class="border rounded-circle " style="border-image-outset: 100px; width:50%; height: 150px;">
        </div>
        ...
        <div  class="list-group text-left">
            ...
            <div id="description" class="border collapse">
                {{($program->description=='')? 'no data':$program->description}}
            </div>
            ...
            <div id="goals" class="border collapse">
                {!! ($program->goals=='')? 'no data':$program->goals !!}
            </div>
        </div>

        <br>
        <a href="/programs/{{$program->id}}/edit" class="btn btn-outline-success">Edit program</a>
    </div>
    ...
    <div class="widget border"  style=" border-radius:15px; margin-top:25px; margin-bottom:25px; padding:20px;  box-shadow: 3px 2px;">
        ...
        <div  class="list-group collapse" id="numbers">
            <a class="list-group-item list-group-item-light list-group-item-action">
                ...
                <span class="badge badge-pill badge-primary pull-right">{{($program->created_at=='')? 'not activated':$program->created_at->format('M d,Y')}}</span>
            </a>
            <a class="list-group-item list-group-item-light list-group-item-action">
            ...
            <a class="list-group-item list-group-item-light list-group-item-action">
                <i class="fa fa-bookmark-o"></i> projects 
