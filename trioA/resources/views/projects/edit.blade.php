                ...
                <div class="card-body row">
                        ...
                        <div class="card"  style=" margin-bottom:15px; box-shadow: 3px 2px;">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('project_name', $project->name ,['class' => 'form-control' , 'placeholder'=>'project Name']) }}
                                </div>
                                <div class="form-group">
                                    {{Form::label( 'project_arname' , 'Arabic Name')}}
                                    {{Form::text( 'project_arname' , $project->arname , [ 'class'=>'form-control' , 'placeholder'=>'Arabic Name' ])}}
                                </div>
                                <hr>
                                <div class="form-group" style="margin-bottom:20px;">
                                    {{Form::label( 'project_description' , 'description')}}
                                    {{Form::text( 'project_description' , $project->description , [ 'class'=>'form-control' , 'placeholder'=>'write a description' ])}}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card"  style=" margin-bottom:15px; box-shadow: 3px 2px;">
                            ...
                            <div class="card-body">
                                <div class="form-group text-center" style="margin-bottom:0px;">
                                    ...
                                    <img src="/storage/img/projects/images/{{$project->image}}" alt="" class="border " style="max-width:100%; max-height:250px; postion:absolute;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card"  style=" margin-bottom:15px; box-shadow: 3px 2px;">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    {{ Form::textarea('goals-ckeditor', $project->goals,['id'=>'goals-ckeditor', 'name'=>'goals-ckeditor', 'class' => 'form-control' , 'placeholder'=>'Goals']) }}
                                    <script>
