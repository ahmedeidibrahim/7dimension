        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Thanks for registering with our platform. We will message you to verify your phone number in a jiffy. Provide the code below.</p>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="col-8">
                                <form method="post" action="{{ route('phoneverification.verify') }}"> 
                                    ...
                                    <label for="code">Verification Code '{{Auth()->User()->verification_code}}'</label>
